...
declare module dragonBones {
     ...
     * @version DragonBones 4.7
     */
    function buildMovie(movieName: string, groupName?: string): dragonBones.Movie;
    /**
     * @language zh_CN
     * 获取指定动画组内包含的所有动画名称。
     * @param groupName 动画组的名称。
...
declare module dragonBones {
    ...
    class EgretFactory extends BaseFactory {
         ...
         * @version DragonBones 4.5
         */
        parseTextureAtlasData(rawData: any, textureAtlas: Object, name?: string, scale?: number): any;
        /**
         * @language zh_CN
         ...
         * @version DragonBones 4.5
         */
        buildArmatureDisplay(armatureName: string, dragonBonesName?: string, skinName?: string): any;
        /**
         * 清除所有的数据。
